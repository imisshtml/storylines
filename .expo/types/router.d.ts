  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `/creation`; params?: Router.UnknownInputParams }
        ...
        | { pathname: `${'/(tabs)'}/create` | `/create`; params?: Router.UnknownInputParams }
      ...
      hrefOutputParams:
        ...
        | { pathname: `/creation`; params?: Router.UnknownOutputParams }
        | { pathname: `/dev`; params?: Router.UnknownOutputParams }
        ...
        | { pathname: `${'/(tabs)'}/create` | `/create`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/invite` | `/invite`; params?: Router.UnknownOutputParams }
        | { pathname: `/story`; params?: Router.UnknownOutputParams };
      ...
      href:
        ...
        | `${'/(tabs)'}/create${`?${string}` | `#${string}` | ''}`
        | `/create${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}/invite${`?${string}` | `#${string}` | ''}`
