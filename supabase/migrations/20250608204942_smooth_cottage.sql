...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE campaigns 
      ADD COLUMN content_level text NOT NULL DEFAULT 'adults' CHECK (content_level IN ('kids', 'teens', 'adults'));
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE campaigns 
      ADD COLUMN rp_focus text NOT NULL DEFAULT 'balanced' CHECK (rp_focus IN ('heavy_rp', 'rp_focused', 'balanced', 'combat_focused', 'heavy_combat'));
  END IF;
